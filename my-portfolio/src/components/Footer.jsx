...
function Footer() {
  return (
    <section className="end">
      ...
      >
        {" "}
        <img src="https://imgur.com/nIfOFSN.png" height="18" width="20" />{" "}
      </a>
      <a className="contact-link" href="https://github.com/ymayers/">
        {" "}
        <img src="https://imgur.com/tMWkbtZ.png" height="18" width="20" />{" "}
      </a>
      <a className="contact-link" href="mailto:yoleamayers@gmail.com">
        <img src="https://imgur.com/iqVkRRS.png" height="15" width="20" />
      </a>
    </section>
  );
}
